...
const StyledWrapper = styled.div`
  ...
  .theme-switch__checkbox:focus-visible + .theme-switch__container {
    outline: 3px solid oklch(var(--color-accent) / 0.45);
    outline-offset: 3px;
  }

  .theme-switch__checkbox:disabled + .theme-switch__container {
    cursor: not-allowed;
    opacity: 0.55;
  }
  ...
  .theme-switch__checkbox:not(:disabled):checked + .theme-switch__container .theme-switch__circle-container:hover {
    left: calc(100% - var(--circle-container-offset) - var(--circle-container-diameter) - 0.187em)
  }

  .theme-switch__checkbox:not(:disabled) + .theme-switch__container .theme-switch__circle-container:hover {
