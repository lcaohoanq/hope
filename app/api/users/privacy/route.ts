...
export async function PATCH(request: Request) {
  ...
  const isPrivate = body && typeof body === "object" ? (body as { isPrivate?: unknown }).isPrivate : undefined;
  if (typeof isPrivate !== "boolean") return NextResponse.json({ success: false, error: "isPrivate must be a boolean." }, { status: 400 });
